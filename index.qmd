...
Do odtworzenia przykładów oraz do wykonania zadań zawartych w tym dokumencie konieczne jest posiadanie aktualnej wersji **R**. 
...
Można je zainstalować korzystając ze strony <https://posit.co/download/rstudio-desktop/#download>.
...
Należy również posiadać konto na platformie [**GitHub**](https://github.com/).
Warto wtedy zastanowić się nad wyborem nazwy użytkownika, ponieważ jest ona sposobem identyfikacji oraz kontaktu z innymi użytkownikami na GitHubie.^[Zmiana nazwy jest możliwa później.]